...
const AI2_INSTRUCTIONS = [
  ...
  'Las preferencias aprendidas sirven solo para ordenar y asignar prioridad entre candidatas ya validas; nunca prueban territorio, actividad, titularidad ni condicion de beneficiario.',
  ...
  return [
    ...
    JSON.stringify({
      user_profile: {
        ...
        learned_preferences: user.learned_preferences || { interests: [], dislikes: [] },
      },
