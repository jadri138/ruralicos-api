...
const TAXONOMIA_RURALICOS = [
  ...
  { id: 'sector:ganaderia', label: 'Ganaderia', featureTag: 'sector:ganaderia', aliases: ['ganaderia', 'ganadero', 'ganadera', 'ganaderos', 'ganaderas', 'ganaderias', 'explotacion ganadera', 'explotaciones ganaderas', 'cabana ganadera', 'cabanas ganaderas', 'ganado', 'reses', 'pecuario', 'pecuaria', 'pecuarios', 'pecuarias'], feedbackCanonico: 'ganaderia', sector: 'ganaderia' },
  ...
  { id: 'subsector:ovino', label: 'Ovino', featureTag: 'subsector:ovino', aliases: ['ovino', 'ovina', 'ovinos', 'ovinas', 'oveja', 'ovejas', 'cordero', 'corderos', 'ganado ovino', 'lana', 'rebano', 'rebanos'], feedbackCanonico: 'ovino', sector: 'ganaderia' },
  { id: 'subsector:caprino', label: 'Caprino', featureTag: 'subsector:caprino', aliases: ['caprino', 'caprina', 'caprinos', 'caprinas', 'cabra', 'cabras', 'cabrito', 'cabritos', 'ganado caprino', 'macho cabrio'], feedbackCanonico: 'caprino', sector: 'ganaderia' },
  { id: 'subsector:vacuno', label: 'Vacuno', featureTag: 'subsector:vacuno', aliases: ['vacuno', 'vaca', 'vacas', 'bovino', 'bovina', 'bovinos', 'bovinas', 'ternero', 'terneros', 'ternera', 'terneras', 'toro', 'toros', 'novillo', 'vaca nodriza', 'vacas nodrizas', 'vacuno de leche', 'vacuno de carne', 'ganado vacuno', 'ganado bovino'], feedbackCanonico: 'vacuno', sector: 'ganaderia' },
  { id: 'subsector:porcino', label: 'Porcino', featureTag: 'subsector:porcino', aliases: ['porcino', 'porcina', 'porcinos', 'porcinas', 'cerdo', 'cerdos', 'cochino', 'cochinos', 'cerda', 'cebo', 'lechon', 'lechones', 'porcino iberico', 'cerdo iberico', 'ganado porcino'], feedbackCanonico: 'porcino', sector: 'ganaderia' },
  { id: 'subsector:avicultura', label: 'Avicultura', featureTag: 'subsector:avicultura', aliases: ['avicultura', 'avicola', 'avicolas', 'ave', 'aves', 'pollo', 'pollos', 'gallina', 'gallinas', 'gallina ponedora', 'gallinas ponedoras', 'pavo', 'pavos', 'huevo', 'huevos', 'granja avicola', 'broiler'], feedbackCanonico: 'avicultura', sector: 'ganaderia' },
  { id: 'subsector:apicultura', label: 'Apicultura', featureTag: 'subsector:apicultura', aliases: ['apicultura', 'apicola', 'apicolas', 'abeja', 'abejas', 'miel', 'colmena', 'colmenas', 'colmenar', 'apicultor', 'apicultora', 'apicultores', 'apicultoras', 'polen', 'cera'], feedbackCanonico: 'apicultura', sector: 'ganaderia' },
  { id: 'subsector:cunicultura', label: 'Cunicultura', featureTag: 'subsector:cunicultura', aliases: ['cunicultura', 'conejo', 'conejos', 'cunicola', 'cunicolas', 'granja cunicola'], feedbackCanonico: 'cunicultura', sector: 'ganaderia' },
  { id: 'subsector:equino', label: 'Equino', featureTag: 'subsector:equino', aliases: ['equino', 'equina', 'equinos', 'equinas', 'equinocultura', 'caballo', 'caballos', 'yegua', 'yeguas', 'potro', 'equido', 'equidos', 'ganado equino'], feedbackCanonico: 'equinocultura', sector: 'ganaderia' },
