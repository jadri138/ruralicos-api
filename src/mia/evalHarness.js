...
const MIA_EVAL_FIXTURES = [
  ...
  {
    id: 'pregunta_demasiado_vaga',
    texto: 'cuando sale?',
    digest: null,
    alertasDelDigest: [],
    perfilOperativo: { interests: [], declared: { provincias: [], sectores: [] } },
    interpretacion: {
      feedbacks: [],
      memoria: [{ tipo: 'pregunta_usuario', contenido: 'Pregunta vaga', peso_inicial: 0.5 }],
      requiere_respuesta: true,
      respuesta: 'No estoy seguro.',
      intencion: 'pregunta',
      resumen_para_log: 'Pregunta vaga',
    },
    knowledgeResult: {
      answered: false,
      needs_agent: true,
      ...
      reply: 'Lo revisa un agente de Ruralicos.',
      matches: [],
    },
    expect: {
      intent: 'pregunta_usuario',
      ...
      reply: true,
      replyIncludes: ['dime la ayuda'],
      requiresAgent: false,
      riskFlagsExclude: ['knowledge_no_match', 'digest_missing'],
    },
  },
  {
