...
const SECTOR_ALIASES = entriesMap([
  ...
  ['agroalimentario', 'agricultura'],
  ['agroalimentaria', 'agricultura'],
  ['industria agroalimentaria', 'agricultura'],
  ['transformacion agroalimentaria', 'agricultura'],
  ['cadena alimentaria', 'agricultura'],
  ['cultivo', 'agricultura'],
...
const SUBSECTOR_ALIASES = entriesMap([
  ...
  ['cunicola', 'cunicultura'],
  ['cunicolas', 'cunicultura'],
  ['conejo', 'cunicultura'],
  ['conejos', 'cunicultura'],
  ['equinocultura', 'equinocultura'],
  ['equino', 'equinocultura'],
  ['equina', 'equinocultura'],
  ['equinos', 'equinocultura'],
  ['equinas', 'equinocultura'],
  ...
  ['pac', 'pac'],
  ['registro_explotaciones', 'registro_explotaciones'],
  ['registro explotaciones', 'registro_explotaciones'],
  ['rega', 'registro_explotaciones'],
  ['regepa', 'registro_explotaciones'],
  ['roma', 'registro_explotaciones'],
  ['bioseguridad', 'bioseguridad'],
  ['calidad_diferenciada', 'calidad_diferenciada'],
  ['calidad diferenciada', 'calidad_diferenciada'],
  ['denominacion de origen', 'calidad_diferenciada'],
  ['indicacion geografica', 'calidad_diferenciada'],
  ['dop', 'calidad_diferenciada'],
  ['igp', 'calidad_diferenciada'],
  ['agroindustria', 'agroindustria'],
  ['industria agroalimentaria', 'agroindustria'],
  ['comercializacion', 'comercializacion'],
  ['cadena alimentaria', 'comercializacion'],
  ['formacion', 'formacion'],
  ['cursos_formacion', 'formacion'],
  ['curso', 'formacion'],
  ['cursos', 'formacion'],
...
const TIPO_ALERTA_ALIASES = entriesMap([
  ...
  ['plazo', 'plazos'],
  ['fecha limite', 'plazos'],
  ['registro_explotaciones', 'normativa_general'],
  ['registro explotaciones', 'normativa_general'],
  ['rega', 'normativa_general'],
  ['regepa', 'normativa_general'],
  ['roma', 'normativa_general'],
  ['formacion', 'formacion'],
  ['curso', 'formacion'],
  ['cursos', 'formacion'],
  ['jornada', 'formacion'],
  ...
  ['fitosanitario', 'sanidad_vegetal'],
  ['fitosanitarios', 'sanidad_vegetal'],
  ['incendios_emergencias', 'incendios_emergencias'],
  ['incendios y emergencias', 'incendios_emergencias'],
  ['incendio forestal', 'incendios_emergencias'],
  ['emergencia', 'incendios_emergencias'],
  ...
  ['forestal', 'forestal'],
  ['montes', 'forestal'],
  ['registros_certificaciones', 'registros_certificaciones'],
  ['registros y certificaciones', 'registros_certificaciones'],
  ['certificacion', 'registros_certificaciones'],
  ['registro', 'registros_certificaciones'],
  ['plazos_alegaciones', 'plazos_alegaciones'],
  ['plazo de alegaciones', 'plazos_alegaciones'],
  ['alegaciones', 'plazos_alegaciones'],
  ['seguros_agrarios', 'seguros_agrarios'],
